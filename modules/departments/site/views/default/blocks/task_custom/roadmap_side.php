...
<div class="wrapper">
   <div class="step">
    <div class="form-md-radios md-radio-inline b-page-checkbox-wrap">
        ...
        <div class="md-radio item-1 has-test b-page-checkbox done" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(284)?>" data-toggle="popover">
        ...
        <div class="md-radio item-2 has-test b-page-checkbox" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(282)?>" data-toggle="popover">
        ...
        <div class="md-radio item-3 has-test b-page-checkbox" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(283)?>" data-toggle="popover">
        ...
        <div class="md-radio item-4 has-test b-page-checkbox" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(37)?>" data-toggle="popover">
        ...
        <div class="md-radio item-5 has-test b-page-checkbox" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(38)?>" data-toggle="popover">
        ...
        <div class="md-radio item-6 has-test b-page-checkbox" title="<?php echo \modules\departments\tool\TaskComponent::getTaskTitle(39)?>" data-toggle="popover">
