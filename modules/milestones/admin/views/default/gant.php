...
$this->registerCssFile("/js/jQueryGantt/platform.css");
$this->registerCssFile("/js/jQueryGantt/libs/dateField/jquery.dateField.css");
$this->registerCssFile("/js/jQueryGantt/gantt.css");
// $this->registerCssFile("/js/jQueryGantt/ganttPrint.css");
$this->registerCssFile("/js/jQueryGantt/libs/jquery.svg.css");

$this->registerJsFile("/js/jQueryGantt/libs/jquery.svg.min.js");
$this->registerJsFile("/js/jQueryGantt/libs/jquery.svgdom.1.8.js");


$this->registerJsFile("/js/jQueryGantt/libs/jquery.livequery.min.js");
$this->registerJsFile("/js/jQueryGantt/libs/jquery.timers.js");
$this->registerJsFile("/js/jQueryGantt/libs/platform.js");
$this->registerJsFile("/js/jQueryGantt/libs/date.js");
$this->registerJsFile("/js/jQueryGantt/libs/i18nJs.js");
$this->registerJsFile("/js/jQueryGantt/libs/dateField/jquery.dateField.js");
$this->registerJsFile("/js/jQueryGantt/libs/JST/jquery.JST.js");

$this->registerJsFile("/js/jQueryGantt/ganttUtilities.js");
$this->registerJsFile("/js/jQueryGantt/ganttTask.js");
$this->registerJsFile("/js/jQueryGantt/ganttDrawerSVG.js");
$this->registerJsFile("/js/jQueryGantt/ganttGridEditor.js");
$this->registerJsFile("/js/jQueryGantt/ganttMaster.js");
        ...
        <div class="portlet">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a href="<?= Url::toRoute(['/milestones/view','id' => $milestone->id,'view'=>'list']) ?>" class="btn default blue-stripe">
                        <i class="fa fa-table"></i>
								<span class="hidden-480">
								List </span>
                    </a>
                    <a href="<?= Url::toRoute(['/milestones/view','id' => $milestone->id,'view'=>'gant']) ?>" class="btn default blue-stripe">
...
<form id="gimmeBack" style="display:none;" action="#" method="post" target="_blank"><input type="hidden" name="prj" id="gimBaPrj"></form>
...
//   $(".ganttButtonBar h1").html("<a href='http://twproject.com' title='Twproject the friendly project and work management tool' target='_blank'><img width='80%' src='/js/jQueryGantt/res/twBanner.jpg'></a>");
...
<script type="text/javascript">
  ...
  $.JST.loadDecorator("ASSIGNMENT_ROW", function(assigTr, taskAssig) {
    ...
    if (_messagesFromController.length>0){
        ...
        place.fadeIn();
        $("body").oneTime(3000,"hideffc",function(){$(".FFC_OK").slideUp();});
    } else {
        place.hide().empty();
    }
