    ...
    <div class="page-header">
        ...
        <div class="page-header-top">
            <div class="page-container">
                ...
                <a id="show-hor-menu" href="javascript:;" class="menu-toggler menu_departments-toggler" data-toggle="dropdown"><div class="menu_departments">Departments</div></a>
                ...
                <div class="top-menu navbar-notification">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-extended dropdown-dark dropdown-notification mobile-small-nav" id="header_notification_bar">
                        ...
                        <!-- BEGIN TODO DROPDOWN -->
                        <li class="dropdown dropdown-extended dropdown-dark dropdown-tasks mobile-small-nav" id="header_task_bar">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"  data-close-others="true">
                        ...
                        <li class="dropdown dropdown-user dropdown-dark">
                            <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                                ...
                                <span class="username username-hide-mobile">Marta</span>
                            </a>
...
<script>
    $( document ).ready(function() {
        ...
        $(".navbar-ico-nav-toggler").click(function(){
            $("#navbar-ico-nav").slideToggle('slow');
