            ...
            <div class="section-cell">
                <div class="container">
                    ...
                    <div class="section-header row text-center">
                        <div class="col-xs-12">
                            <p class="animation section-subtitle">Coming soon</p>
                            <h1 class="section-title">
                                <span class="section-title-span">Business around your Soul</span>
...
<footer id="site-footer">
    ...
    <div id="footer-social">
        <a href="https://www.facebook.com/bigSbusiness" title="" target="_blank"><i class="ion-social-facebook"></i></a>
        <a href="https://twitter.com/BigSBusiness" title="" target="_blank"><i class="ion-social-twitter"></i></a>
    </div>
    <!-- /footer social -->
</footer>
<!-- /site footer -->
