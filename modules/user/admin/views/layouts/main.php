...
?>
    ...
    <!doctype html>
    <html lang="<?= Yii::$app->language ?>" class="no-js" style="background: #3a3a3a;">
    <!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        ...
        <link rel="stylesheet" type="text/css" href="/metronic/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css"/>
        ...
        <!-- ICOMOON -->
        <link href="/metronic/icomoon/style.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="page-logo">
        <a href="/">
            <img src="/metronic/assets/admin/layout3/img/logo-default.png" alt="logo" class="logo-default"/>
        </a>
    ...
    <script type="text/javascript" src="/metronic/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
    ...
    <script src="/metronic/assets/admin/pages/scripts/table-ajax.js"></script>
