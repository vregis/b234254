...
(function(jQuery) {
    ...
    function build(options) {
        ...
        function build() {
            var minDays = Math.floor((opts.slideWidth / opts.cellWidth) + 55);
            ...
            els.each(function() {
                ...
                new Chart(container, opts).render();
    ...
    var Chart = function(div, opts) {
        ...
        //     var headerDiv = div.parents(".wrapper").find(jQuery(".ganttview-vtheader"));
        //     for (var i = 0; i < data.length; i++) {
        //         var itemDiv = headerDiv.find(jQuery(".ganttview-vtheader-group"));
        //         var usersDiv = headerDiv.find(jQuery(".milestones-users"));
        //         for (var u = 0; u <= 5; u++) {
        //             usersDiv
        //                 .append(
        //                     function() {
        //                         var avatar = "<img src='https://zhestokij-realist.ru/wp-content/uploads/2014/06/putin_vseh_prodal.jpg' title='asdasdsa' /></div>";
        //                         return avatar
        //                     }
        //                 );
        //         }
        ...
        //         var seriesDiv = headerDiv.find(jQuery(".ganttview-vtheader-series"));
        //         for (var j = 0; j < data[i].series.length; j++) {
        //             seriesDiv
        //                 .append(jQuery("<div>", { "class": "ganttview-vtheader-series-row" })
        //                 .append(
        //                     function() {
        //                         var text = "<div class='series-content'>" +
        ...
        //     //     var usersDiv = jQuery("<div>", {"class": "milestones-users","id": "groupId_" + i});
        //     //     for (var u = 0; u <= 5; u++) {
        //     //         usersDiv
        //     //             .append(
        //     //                 function() {
    ...
    var DateUtils = {
        ...
        daysBetween: function(start, end) {
            ...
            if (moment(start)._d.getYear() == 1901 || moment(end)._d.getYear() == 8099) {
                return 0;
            }
        ...
        getBoundaryDatesFromData: function(data, minDays) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    if (moment(minStart).isAfter(start)) {
                        minStart = start;
                    }
                    if (moment(maxEnd).isBefore(end)) {
                        maxEnd = end;
                    }
                }
            }
