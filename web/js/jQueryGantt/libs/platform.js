...
function openBlackPopup(url,width,height,onCloseCallBack,iframeId){
  ...
  //bg.css({position:'fixed',top:0, left:0,width:'100%',height:'100%', backgroundImage:"url('/js/jQueryGantt/res/black_70.png')",textAlign:'center'});
  ...
  if(window.name!=iframeId)
    bg.css({backgroundImage:"url('/js/jQueryGantt/res/black_70.png')"});
...
function createBlackPage(width,height,onCloseCallBack){
  ...
  var bg=$("<div>").attr("id","__blackpopup__");
  bg.css({position:'fixed',top:"0px",paddingTop:"50px", left:0,width:'100%',height:'100%',  backgroundImage:"url('/js/jQueryGantt/res/black_70.png')"});
  bg.append("<div id='bwinPopupd' name='bwinPopupd' class='blackpopup'></div>");
  bg.bringToFront();
