            ...
            function s(s) {
                if (o.env.isWebKit || !t.querySelector("select:focus")) {
                    var c = r(s),
                        u = c[0],
                        d = c[1];
                    i(u, d) || (a = !1, e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (d ? t.scrollTop = t.scrollTop - d * e.settings.wheelSpeed : t.scrollTop = t.scrollTop + u * e.settings.wheelSpeed, a = !0) : e.scrollbarXActive && !e.scrollbarYActive && (u ? t.scrollLeft = t.scrollLeft + u * e.settings.wheelSpeed : t.scrollLeft = t.scrollLeft - d * e.settings.wheelSpeed, a = !0) : (t.scrollTop = t.scrollTop - d * e.settings.wheelSpeed, t.scrollLeft = t.scrollLeft + u * e.settings.wheelSpeed), l(t), a = a || n(u, d), a && (s.stopPropagation(), s.preventDefault()))
                }
            }
            var a = !1;
        ...
        function r(t, e) {
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function() {
                ...
                if (u) {
                    ...
                    n.x < i.left + 3 ? (c.left = -5, o.startScrolling(t, "x")) : n.x > i.right - 3 ? (c.left = 5, o.startScrolling(t, "x")) : c.left = 0, n.y < i.top + 3 ? (i.top + 3 - n.y < 5 ? c.top = -5 : c.top = -20, o.startScrolling(t, "y")) : n.y > i.bottom - 3 ? (n.y - i.bottom + 3 < 5 ? c.top = 5 : c.top = 20, o.startScrolling(t, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? s() : r()
                }
            })
        }
        var o = t("../../lib/helper"),
...
=================================================*/
! function(t) {
    t.fn.downCount = function(i, n) {
        function e() {
            var t = new Date(o.date),
                i = a(),
                e = t - i;
            if (0 > e) return clearInterval(r), void(n && "function" == typeof n && n());
            var h = 1e3,
                c = 60 * h,
                d = 60 * c,
                l = 24 * d,
                ...
                y = Math.floor(e % d / c),
                x = Math.floor(e % c / h);
            f = String(f).length >= 2 ? f : "0" + f, u = String(u).length >= 2 ? u : "0" + u, y = String(y).length >= 2 ? y : "0" + y, x = String(x).length >= 2 ? x : "0" + x;
            var v = 1 === f ? "day" : "days",
                g = 1 === u ? "hour" : "hours",
                p = 1 === y ? "minute" : "minutes",
                w = 1 === x ? "second" : "seconds";
            s.find(".days").text(f), s.find(".hours").text(u), s.find(".minutes").text(y), s.find(".seconds").text(x)
                /*
                ,s.find(".days_ref").text(v),s.find(".hours_ref").text(g),s.find(".minutes_ref").text(p),s.find(".seconds_ref").text(w)
                */
        }
        var o = t.extend({
            date: null,
...
! function(t) {
    function i(i, n, e, o) {
        var s = i.text(),
            a = s.split(n),
            h = "";
        a.length && (t(a).each(function(t, i) {
            h += '<span class="' + e + (t + 1) + '" aria-hidden="true">' + i + "</span>" + o
        }), i.attr("aria-label", s).empty().append(h))
    }
    var n = {
        init: function() {
            return this.each(function() {
        ...
        lines: function() {
            return this.each(function() {
                ...
                i(t(this).children("br").replaceWith(n).end(), n, "line", "")
            })
        }
    };
...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        changeMovie: function(e) {
            ...
            r.opt.startAt = 0, r.opt.stopAt = 0, r.opt.mute = !0, r.hasData = !1, r.hasChanged = !0, e && jQuery.extend(r.opt, r.defaultOpt, e), r.videoID = getYTPVideoID(r.opt.videoURL).videoID, jQuery(r.playerEl).CSSAnimate({
                ...
                return jQuery(r).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + r.videoID), 1, r.opt.quality), jQuery.mbYTPlayer.checkForState(r), jQuery(r).optimizeDisplay(), jQuery.mbYTPlayer.getDataFromAPI(r), this
            })
        },
        getPlayer: function() {
        ...
        play: function() {
            ...
            if (e.isReady) {
                ...
                return t.html(jQuery.mbYTPlayer.controls.pause), e.player.playVideo(), e.wrapper.CSSAnimate({
        ...
        pause: function() {
            var e = this.get(0),
                r = jQuery("#controlBar_" + e.id),
                t = r.find(".mb_YTPPlaypause");
            return t.html(jQuery.mbYTPlayer.controls.play), e.player.pauseVideo(), this
        },
        seekTo: function(e) {
            var r = this.get(0);
        ...
        mute: function() {
            ...
            if (!e.isMute) {
                ...
                return a.time = e.player.time, e.canTrigger && jQuery(e).trigger(a), this
            }
        },
        unmute: function() {
            var e = this.get(0);
        ...
        toggleFilter: function(e, r) {
            return this.each(function() {
                var t = this;
                t.filters[e].value = t.filters[e].value ? 0 : r, t.filtersEnabled && jQuery(this).YTPEnableFilters()
            })
        },
        ...
        removeFilter: function(e, r) {
            return this.each(function() {
                ...
                var t = this;
                if (e) jQuery(this).YTPApplyFilter(e, 0), "function" == typeof r && r(e);
                else
    ...
    animate: function(e, r, t, a, o) {
        return this.each(function() {
            ...
            if (l.CSSAIsRunning && l.eventType == u.type && !jQuery.browser.msie && jQuery.browser.version <= 9) return void(l.CSSqueue = function() {
                n.CSSAnimate(e, r, t, a, o)
            });
            if (l.CSSqueue = null, l.eventType = u.type, 0 !== n.length && e) {
                if (e = jQuery.normalizeCss(e), l.CSSAIsRunning = !0, "function" == typeof r && (o = r, r = jQuery.fx.speeds._default), "function" == typeof t && (a = t, t = 0), "string" == typeof t && (o = t, t = 0), "function" == typeof a && (o = a, a = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof r)
                    for (var s in jQuery.fx.speeds) {
                        if (r == s) {
                            r = jQuery.fx.speeds[s];
                            break
                        }
                ...
                c[a] && (a = c[a]), n.off(jQuery.CSS.transitionEnd + "." + l.id);
                var f = jQuery.CSS.getProp(e),
                    P = {};
                jQuery.extend(P, e), P[jQuery.CSS.sfx + "transition-property"] = f, P[jQuery.CSS.sfx + "transition-duration"] = r + "ms", P[jQuery.CSS.sfx + "transition-delay"] = t + "ms", P[jQuery.CSS.sfx + "transition-timing-function"] = a, setTimeout(function() {
                    n.one(jQuery.CSS.transitionEnd + "." + l.id, i), n.css(P)
